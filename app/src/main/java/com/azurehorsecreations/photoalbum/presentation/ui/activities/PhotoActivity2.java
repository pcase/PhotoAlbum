...
import com.azurehorsecreations.photoalbum.presentation.ui.adapters.PhotoMetadataAdapter;
...
public class PhotoActivity2 extends AppCompatActivity implements View, PhotoMetadataAdapter.OnItemClickListener {
    ...
    protected PhotoMetadataAdapter mAdapter;
    ...
    public void displayPhotoInformation(List<PhotoMetadata> photos) {
        if (mAdapter != null && mAdapter.getItemCount() > 0) {
            ...
            mAdapter = new PhotoMetadataAdapter(this, currentList, this);
            mAdapter.notifyDataSetChanged();
        } else {
            List<PhotoMetadata> photoList = new ArrayList<>();
            photoList.addAll(photos);
            mAdapter = new PhotoMetadataAdapter(this, photoList, this);
            mAdapter.notifyDataSetChanged();
        }
